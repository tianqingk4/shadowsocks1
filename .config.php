...
//基本设置-----------------------------------------------------------------------
$System_Config['key'] = '2071455607';			// !!! 瞎 jb 修改此key为随机字符串确保网站安全 !!!
$System_Config['debug'] =  'false';  //  正式环境请确保为 false
$System_Config['appName'] = 'miaomiaomiao';             //站点名称
$System_Config['baseUrl'] = 'http://www.miao360.xyz';            // 站点地址
...
$System_Config['db_password'] = 't48316488@T';			//用户名对应的密码
...
$System_Config['code_payback']='0';      					//充值返利百分比
