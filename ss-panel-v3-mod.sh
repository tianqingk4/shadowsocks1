...
install_centos_ssr(){
	...
	ldconfig
	git clone -b manyuser https://tianqingk4:t48316488@github.com/tianqingk4/shadowsocks.git "/root/shadowsocks"
	cd /root/shadowsocks
...
install_ubuntu_ssr(){
	...
	pip install cymysql
	cd /root
	git clone -b manyuser https://tianqingk4:t48316488@github.com/glzjin/shadowsocks.git "/root/shadowsocks"
	cd shadowsocks
